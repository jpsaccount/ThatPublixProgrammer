      ...
      <Timeline>
        ...
        <Timeline.Item>
          ...
          <Timeline.Content>
            ...
            <Timeline.Body>Timesheet works, but may experience bugs.</Timeline.Body>
          </Timeline.Content>
        </Timeline.Item>

        <Timeline.Item>
          <Timeline.Point icon={() => <PolIcon name="Minus" size="1rem" />} color="var(--primary-900)" />
          <Timeline.Content>
            <Timeline.Time>February 21</Timeline.Time>
            <Timeline.Title>Invoicing (Beta)</Timeline.Title>
            <Timeline.Body>Invoicing works, but may experience bugs.</Timeline.Body>
          </Timeline.Content>
        </Timeline.Item>
        <Timeline.Item>
          <Timeline.Point />
          <Timeline.Content>
            ...
            <Timeline.Title>Client, and Project Management, Dropdown editor (Beta)</Timeline.Title>
            <Timeline.Body>
              These areas will be our next priority, giving more flexibility to the timesheet.
            </Timeline.Body>
          </Timeline.Content>
        </Timeline.Item>
        <Timeline.Item>
