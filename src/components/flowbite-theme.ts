...
const FlowbiteTheme: CustomFlowbiteTheme = {
  ...
  button: {
    color: {
      gray: "text-gray-900 bg-background-950 border border-gray-200 enabled:hover:bg-gray-100 enabled:hover:text-blue-700 :ring-blue-700 focus:text-blue-700 dark:bg-transparent dark:text-gray-400 dark:border-gray-600 dark:enabled:hover:text-white dark:enabled:hover:bg-gray-700 focus:ring-2",
  ...
  modal: {
    content: {
      inner: "relative rounded-lg bg-background-950 shadow dark:bg-gray-800",
    },
    header: {
  ...
  navbar: {
    root: {
      base: "fixed z-30 w-full bg-background-50 border-b border-gray-200 bg-secondary-50 dark:border-gray-700",
    },
  },
  sidebar: {
    root: {
      base: "flex fixed top-0 left-0 z-20 flex-col flex-shrink-0 pt-[43px] h-full duration-75 border-r border-gray-200 lg:flex transition-width dark:border-gray-700",
    },
    item: {
